...
class _CVFormState extends State<CVForm> {
  ...
  final List<String> _allSkills = ['Flutter', 'Dart', 'Java', 'Python', 'JavaScript'];
  ...
  List<TextEditingController> _projectTitleControllers = [];
  List<TextEditingController> _projectDescriptionControllers = [];
  List<DateTime?> _projectStartDates = [];
  List<DateTime?> _projectEndDates = [];
          ...
          child: Column(
            ...
            children: [
              ...
              TextFormField(
                ...
                decoration: InputDecoration(labelText: 'Achievements (Optional)'),
              ),
              SizedBox(height: 20),
                        ...
                        child: TextFormField(
                          ...
                          decoration: InputDecoration(
                            ...
                            hintText: _projectStartDates[i] == null
                                ? 'Select start date'
                                : _projectStartDates[i].toString().split(' ')[0],
                          ),
                          validator: (value) {
